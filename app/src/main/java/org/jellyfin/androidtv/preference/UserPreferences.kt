...
class UserPreferences(context: Context) : SharedPreferenceStore(
	...
	companion object {
		...
		/**
		 * Use VLC for native ASS/SSA subtitle rendering (anime subtitles).
		 * When enabled, VLC will be used for content with ASS/SSA subtitles to preserve styling.
		 */
		var useVlcForAssSubtitles = booleanPreference("use_vlc_for_ass_subtitles", defaultValue = true)
		 ...
		 */
		var defaultRatingType = enumPreference("pref_rating_type", RatingType.RATING_PLUGIN)
