...
import org.jellyfin.androidtv.ui.browsing.NetflixBrowseFragment
...
object Destinations {
	...
	// Netflix-style genre browsing for Movies and TV Shows
	fun libraryNetflix(item: BaseItemDto) = fragmentDestination<NetflixBrowseFragment>(
		Extras.Folder to Json.Default.encodeToString(item),
	)
