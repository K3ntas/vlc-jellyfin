...
fun SettingsSubtitlesScreen() {
	...
	var useVlcForAssSubtitles by rememberPreference(userPreferences, UserPreferences.useVlcForAssSubtitles)
	...
	SettingsColumn {
		...
		item {
			ListButton(
				headingContent = { Text(stringResource(R.string.pref_vlc_ass_subtitles)) },
				trailingContent = { Checkbox(checked = useVlcForAssSubtitles) },
				captionContent = { Text(stringResource(R.string.pref_vlc_ass_subtitles_description)) },
				onClick = { useVlcForAssSubtitles = !useVlcForAssSubtitles }
			)
		}
