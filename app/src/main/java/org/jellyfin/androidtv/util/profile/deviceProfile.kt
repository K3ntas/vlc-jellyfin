...
fun createDeviceProfile(
	...
	assDirectPlay = userPreferences[UserPreferences.useVlcForAssSubtitles],
...
fun createDeviceProfile(
	...
	/// Subtitle profiles
	// When VLC is enabled (assDirectPlay=true), support all subtitle formats directly
	// VLC can render all subtitle types natively
	if (assDirectPlay) {
		// VLC mode: direct play all subtitle formats
		...
		subtitleProfile(Codec.Subtitle.DVBSUB, embedded = true, external = true)
		subtitleProfile(Codec.Subtitle.DVDSUB, embedded = true, external = true)
		subtitleProfile(Codec.Subtitle.IDX, embedded = true, external = true)
		subtitleProfile(Codec.Subtitle.PGS, embedded = true, external = true)
		subtitleProfile(Codec.Subtitle.PGSSUB, embedded = true, external = true)
		...
		// ExoPlayer mode: limited subtitle support
		subtitleProfile(Codec.Subtitle.VTT, embedded = true, hls = true, external = true)
		subtitleProfile(Codec.Subtitle.WEBVTT, embedded = true, hls = true, external = true)
		subtitleProfile(Codec.Subtitle.SRT, embedded = true, external = true)
		subtitleProfile(Codec.Subtitle.SUBRIP, embedded = true, external = true)
