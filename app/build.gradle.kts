...
android {
	...
	defaultConfig {
		...
		// Release version
		applicationId = "org.jellyfin.androidtv.netflix"
	...
	buildTypes {
		release {
			// Note: minification stays off. proguard-rules.pro has never been exercised and the
			// app leans on reflection (Koin, kotlinx.serialization, leanback), so enabling R8
...
dependencies {
	...
	implementation(projects.playback.vlc)
