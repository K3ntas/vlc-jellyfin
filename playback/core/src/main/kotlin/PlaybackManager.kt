...
class PlaybackManager internal constructor(
	val backends: List<PlayerBackend>,
	...
	/**
	 * The default backend (first in list), used for compatibility.
	 */
	val backend: PlayerBackend get() = backends.first()

	internal val backendService = BackendService(backends, backendSelector).also { service ->
